...
Version  : 19.20.13008
Release  : 17
URL      : https://github.com/intel/compute-runtime/archive/19.20.13008.tar.gz
Source0  : https://github.com/intel/compute-runtime/archive/19.20.13008.tar.gz
...
%prep
%setup -q -n compute-runtime-19.20.13008
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1558750915
mkdir -p clr-build
pushd clr-build
