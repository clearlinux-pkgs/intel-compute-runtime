...
Version  : 19.40.14409
Release  : 32
URL      : https://github.com/intel/compute-runtime/archive/19.38.14237/compute-runtime-19.40.14409.tar.gz
Source0  : https://github.com/intel/compute-runtime/archive/19.38.14237/compute-runtime-19.40.14409.tar.gz
...
%prep
%setup -q -n compute-runtime-19.38.14237
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571418864
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/compute-runtime-19.38.14237/LICENSE %{buildroot}/usr/share/package-licenses/intel-compute-runtime/47021b8c525fc84a5270553d63104832f4f99648
cp %{_builddir}/compute-runtime-19.38.14237/third_party/opencl_headers/LICENSE %{buildroot}/usr/share/package-licenses/intel-compute-runtime/7235f6784b4eae4c40a259dcecc7a20e6c487263
pushd clr-build
%make_install
popd
