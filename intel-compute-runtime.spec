...
Version  : 19.24.13171
Release  : 20
URL      : https://github.com/intel/compute-runtime/archive/19.24.13171/compute-runtime-19.24.13171.tar.gz
Source0  : https://github.com/intel/compute-runtime/archive/19.24.13171/compute-runtime-19.24.13171.tar.gz
...
%prep
%setup -q -n compute-runtime-19.24.13171
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1561403211
mkdir -p clr-build
pushd clr-build
