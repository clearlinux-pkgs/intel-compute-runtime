...
Version  : 19.36.14103
Release  : 29
URL      : https://github.com/intel/compute-runtime/archive/19.36.14103/compute-runtime-19.36.14103.tar.gz
Source0  : https://github.com/intel/compute-runtime/archive/19.36.14103/compute-runtime-19.36.14103.tar.gz
...
%prep
%setup -q -n compute-runtime-19.36.14103
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568863239
mkdir -p clr-build
pushd clr-build
