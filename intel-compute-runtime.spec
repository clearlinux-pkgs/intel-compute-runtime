...
Version  : 19.26.13286
Release  : 22
URL      : https://github.com/intel/compute-runtime/archive/19.26.13286/compute-runtime-19.26.13286.tar.gz
Source0  : https://github.com/intel/compute-runtime/archive/19.26.13286/compute-runtime-19.26.13286.tar.gz
...
%prep
%setup -q -n compute-runtime-19.26.13286
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562332051
mkdir -p clr-build
pushd clr-build
