...
Version  : 19.37.14191
Release  : 30
URL      : https://github.com/intel/compute-runtime/archive/19.37.14191/compute-runtime-19.37.14191.tar.gz
Source0  : https://github.com/intel/compute-runtime/archive/19.37.14191/compute-runtime-19.37.14191.tar.gz
...
%prep
%setup -q -n compute-runtime-19.37.14191
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568991454
mkdir -p clr-build
pushd clr-build
