...
%prep
%setup -q -n compute-runtime-19.45.14764
cd %{_builddir}/compute-runtime-19.45.14764
%patch1 -p1
...
cp %{_builddir}/compute-runtime-19.45.14764/third_party/opencl_headers/LICENSE %{buildroot}/usr/share/package-licenses/intel-compute-runtime/7235f6784b4eae4c40a259dcecc7a20e6c487263
pushd clr-build
%make_install
popd
