...
Version  : 19.31.13700
Release  : 25
URL      : https://github.com/intel/compute-runtime/archive/19.31.13700/compute-runtime-19.31.13700.tar.gz
Source0  : https://github.com/intel/compute-runtime/archive/19.31.13700/compute-runtime-19.31.13700.tar.gz
...
%prep
%setup -q -n compute-runtime-19.31.13700
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565461823
mkdir -p clr-build
pushd clr-build
