...
Version  : 19.34.13959
Release  : 27
URL      : https://github.com/intel/compute-runtime/archive/19.34.13959/compute-runtime-19.34.13959.tar.gz
Source0  : https://github.com/intel/compute-runtime/archive/19.34.13959/compute-runtime-19.34.13959.tar.gz
...
%prep
%setup -q -n compute-runtime-19.34.13959
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567181286
mkdir -p clr-build
pushd clr-build
