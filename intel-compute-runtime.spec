...
Version  : 19.22.13062
Release  : 18
URL      : https://github.com/intel/compute-runtime/archive/19.22.13062/compute-runtime-19.22.13062.tar.gz
Source0  : https://github.com/intel/compute-runtime/archive/19.22.13062/compute-runtime-19.22.13062.tar.gz
...
%prep
%setup -q -n compute-runtime-19.22.13062
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1560182564
mkdir -p clr-build
pushd clr-build
