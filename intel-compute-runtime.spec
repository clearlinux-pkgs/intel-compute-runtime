...
Version  : 19.25.13237
Release  : 21
URL      : https://github.com/intel/compute-runtime/archive/19.25.13237/compute-runtime-19.25.13237.tar.gz
Source0  : https://github.com/intel/compute-runtime/archive/19.25.13237/compute-runtime-19.25.13237.tar.gz
...
%prep
%setup -q -n compute-runtime-19.25.13237
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1561965027
mkdir -p clr-build
pushd clr-build
